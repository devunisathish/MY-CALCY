function calculateTotal() {
			...
			if (!isChecked) {
				document.getElementById("result").innerHTML = "Please check the calculation before submitting.";
				return;
			}
			
			document.getElementById("result").innerHTML = "Total amount: " + totalAmount + "<br>" +
